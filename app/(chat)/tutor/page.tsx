    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 py-16 px-8">
      <div className="container mx-auto max-w-6xl">
        <PageHeader
          ...
          description="Chat with AI about your documents and get personalized explanations"
          action={
            <Link 
              href="/tutor/new" 
        ...
        {tutorSessions.length > 0 ? (
          <>
            <SessionList sessions={tutorSessions} type="tutor" />
          ...
          <EmptyState
            ...
            description="Upload a document to start a new tutoring session with our AI"
            action={{
